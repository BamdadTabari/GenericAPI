...
namespace DataLayer;
public interface ILowAccessRepository<TEntity> where TEntity : class, IBaseEntity
{
...
public class LowAccessRepository<TEntity> : ILowAccessRepository<TEntity> where TEntity : class, IBaseEntity
{
    protected readonly DbContext DbContext;

    protected LowAccessRepository(ApplicationDbContext dbContext)
    {
        DbContext = dbContext;
    }
